...
Automated backups run daily at 2 AM via cron. The backup script is located at:
...
ls -lh /Volumes/intel-system/backups/mem0/weekly/
ls -lh /Volumes/intel-system/backups/mem0/monthly/
```
...
```bash
# Choose a backup timestamp (e.g., 20251016_020000)
BACKUP_TIMESTAMP="20251016_020000"

# Restore PostgreSQL
gunzip < /Volumes/intel-system/backups/mem0/daily/${BACKUP_TIMESTAMP}/postgres/mem0_${BACKUP_TIMESTAMP}.sql.gz | \
